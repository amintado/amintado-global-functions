...
class AmintadoFunctions extends Component {
    ...
    /**
     * Will set A Password For Current User
     * @param $password
     * @return string
     */
    ...
    /**
     * Will send an email from elastic mail service
     * @param $to
     * @param $subject
     * @param null $from
     * @param null $fromName
     * @param null $body_text
    ...
    /**
     * will send a message from telegram to preset bot ID
     *
     *
     * this function need telegram
     * @param $text
     */
    public function telegram($text){
        Yii::$app->telegram->sendMessage(['chat_id' => $this->telegram_bot, 'text' => $text]);
        return;
    }
    /**
